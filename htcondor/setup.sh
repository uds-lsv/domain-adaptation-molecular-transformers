...
DATA_DIR=/data/users/mrdupont/emtrl/data
RESULT_DIR=/data/users/mrdupont/emtrl/results
MODEL_DIR=/data/users/mrdupont/emtrl/models
...
export WANDB_DIR=/data/users/mrdupont/emtrl/wandb
